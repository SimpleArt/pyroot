...
from typing import Callable, Iterable, Optional, Sequence, SupportsFloat, List as list

from . import _utils
from ._src import root_in as _root_in
...
def bisection(
    ...
    *,
    ...
    return _root_in.bisection(f, x1, x2, x, y1, y2, abs_err, rel_err, abs_tol, rel_tol)
...
def chandrupatla(
    ...
    *,
    ...
    rel_err = min(rel_err, 0.5)
    rel_tol = min(rel_tol, 0.5)
    return _root_in.chandrupatla(f, x1, x2, x, y1, y2, abs_err, rel_err, abs_tol, rel_tol)
...
def heun_ode(
    ...
    *,
    ...
    rel_err = min(rel_err, 0.5)
    rel_tol = min(rel_tol, 0.5)
    return _root_in.heun_ode(f, x1, x2, fprime, x, y1, y2, abs_err, rel_err, abs_tol, rel_tol)
...
def midpoint_ode(
    ...
    *,
    ...
    rel_err = min(rel_err, 0.5)
    rel_tol = min(rel_tol, 0.5)
    return _root_in.midpoint_ode(f, x1, x2, fprime, x, y1, y2, abs_err, rel_err, abs_tol, rel_tol)
...
def multivariate_bisection(
    ...
    *,
    ...
    rel_err = min(rel_err, 0.5)
    rel_tol = min(rel_tol, 0.5)
    return _root_in.multivariate_bisection(f, x1, x2, x, y1, y2, abs_err, rel_err, abs_tol, rel_tol)
...
def newton(
    ...
    *,
    ...
    rel_err = min(rel_err, 0.5)
    rel_tol = min(rel_tol, 0.5)
    return _root_in.newton(f, x1, x2, fprime, x, y1, y2, abs_err, rel_err, abs_tol, rel_tol)
...
def newton_ode(
    ...
    *,
    ...
    rel_err = min(rel_err, 0.5)
    rel_tol = min(rel_tol, 0.5)
    return _root_in.newton_ode(f, x1, x2, fprime, x, y1, y2, abs_err, rel_err, abs_tol, rel_tol)
...
def non_simple(
    ...
    *,
    ...
    rel_err = min(rel_err, 0.5)
    rel_tol = min(rel_tol, 0.5)
    return _root_in.non_simple(f, x1, x2, x, y1, y2, abs_err, rel_err, abs_tol, rel_tol)
...
def rk45_ode(
    ...
    *,
    ...
    rel_err = min(rel_err, 0.5)
    rel_tol = min(rel_tol, 0.5)
    return _root_in.rk45_ode(f, x1, x2, fprime, x, y1, y2, abs_err, rel_err, abs_tol, rel_tol)
...
def secant(
    ...
    *,
    ...
    rel_err = min(rel_err, 0.5)
    rel_tol = min(rel_tol, 0.5)
    return _root_in.secant(f, x1, x2, x, y1, y2, abs_err, rel_err, abs_tol, rel_tol)
...
def stochastic(
    ...
    *,
    ...
    rel_err = min(rel_err, 0.5)
    rel_tol = min(rel_tol, 0.5)
    return _root_in.stochastic(f, x1, x2, _utils.inv_cdf(probability), x, y1, y2, abs_err, rel_err, abs_tol, rel_tol)
